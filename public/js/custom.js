(function ($) {
    ...
    $(document).ready(function () {
       ...
       ============================*/
        ...
        //    'animate__slideInDown', 'animate__slideInUp', 'animate__slideInLeft', 'animate__slideInRight',
        //    'animate__zoomIn', 'animate__zoomInDown', 'animate__zoomInUp', 'animate__zoomInLeft', 'animate__zoomInRight',
        //    'animate__flipInX', 'animate__flipInY', 'animate__bounceIn', 'animate__bounceInDown', 'animate__bounceInUp',
        //    'animate__jackInTheBox', 'animate__rollIn', 'animate__lightSpeedInRight', 'animate__lightSpeedInLeft'
        //];
        const animations = [
            'animate__zoomInDown', 'animate__zoomInUp', 'animate__zoomInLeft', 'animate__zoomInRight'
        ];

        const speeds = ['animate__slower'];

        // Animate a given slide immediately
        function animateSlide($slide) {
            if (!$slide.length) return;

            const $img = $slide.find('img');
            const $text = $slide.find('.slide-text');

            // Remove previous animation classes
            $img.removeClass(animations.join(' ') + ' animate__animated ' + speeds.join(' '));
            $text.removeClass(animations.join(' ') + ' animate__animated ' + speeds.join(' '));
            ...
            const imgAnim = animations[Math.floor(Math.random() * animations.length)];
            const textAnim = animations[Math.floor(Math.random() * animations.length)];
            const imgSpeed = speeds[Math.floor(Math.random() * speeds.length)];
            const textSpeed = speeds[Math.floor(Math.random() * speeds.length)];

            // Apply classes
            $img.addClass('animate__animated ' + imgAnim + ' ' + imgSpeed);
            $text.addClass('animate__animated ' + textAnim + ' ' + textSpeed);
        }
        ...
        // Animate the **first visible slide immediately**
        animateSlide($('.banner-carousel .slick-current').not('.slick-cloned'));

        // Animate **next slide immediately when it starts showing**
        $('.banner-carousel').on('beforeChange', function (event, slick, currentSlide, nextSlide) {
            const $next = $(slick.$slides[nextSlide]).not('.slick-cloned');
            animateSlide($next);
        });
